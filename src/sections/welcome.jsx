...
const Welcome = () => {
    ...
    return (
        <section className='w-full flex flex-col welcome gap-10 mt-14 lg:mt-28 md:mt-24 md:flex-row md:gap-6 md:px-14 md:max-h-min xl:px-20 xl:gap-10 xl:mt-30' id='welcome'>
            ...
            <div className=' px-4 space-y-3 xl:w-[58%] xl:space-y-3 lg:w-[80%] lg:space-x- md:w-[100%] md:px-0 md:space-y-2  md:order-' id='welcome_text'>
            ...
            <div className='desktop w-[40%] space-y- mt-[-65px]'>
